...
(import "events" "piececrowned"
 (func $notify_piececrowned (param $pieceX i32) (param $pieceY i32)))
  ...
  (func $offsetForPosition (param $x i32) (param $y i32) (result i32)
    (i32.mul (call $indexForPosition (get_local $x) (get_local $y)) (i32.const 4))
  )
  ...
  ;; Gets a piece from the board. Out of range casuses a trap
 ...
 (func $shouldCrown (param $pieceY i32) (param $piece i32) (result i32)
   ...
   (i32.and
   (i32.eq
   (get_local $pieceY) (i32.const 7))
   (call $isWhite (get_local $piece)))))

  ;;Converts a piece into a crowned piecce and invokes a host notifier
  ...
  ;;Use this to determine if distance is valid movement
  ...
  ;; Place the white pieces at the top of the board
    ...
    ;; Place the white pieces in the 2nd row
    ...
    ;; Place the white pieces in the 3rd row
    (call $setPiece (i32.const 0) (i32.const 2) (i32.const 2))
    (call $setPiece (i32.const 2) (i32.const 3) (i32.const 2))
    (call $setPiece (i32.const 4) (i32.const 3) (i32.const 2))
    (call $setPiece (i32.const 6) (i32.const 3) (i32.const 2))

    ;; Place the black pieces at the 6th of the board
    ...
    ;; Place the black pieces in the 7th row
    ...
    ;; Place the black pieces in the 8th row
